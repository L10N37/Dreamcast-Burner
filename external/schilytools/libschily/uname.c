...
/*
 * RB_MINGW_GETHOSTNAME_PROTO
 * windows.h was included with Winsock gethostname renamed above. Declare
 * Schily's own libschily/gethostname.c fallback for the call below.
 */
