...
{
	/*
	 * RB_MINGW_GETCOMPUTERNAME_DWORD
	 * GetComputerNameA() requires LPDWORD. Use the Win32 API's exact type
	 * rather than Schily's generic UInt32_t typedef.
	 */
	DWORD		len = (DWORD)namelen;
