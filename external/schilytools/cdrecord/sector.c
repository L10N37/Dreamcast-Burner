...
EXPORT	void	encsectors	__PR((track_t *trackp, unsigned char *bp, int address, int nsecs));
EXPORT	void	scrsectors	__PR((track_t *trackp, unsigned char *bp, int address, int nsecs));
EXPORT	void	encodesector	__PR((unsigned char *sp, int sectype, int address));
EXPORT	void	fillsector	__PR((unsigned char *sp, int sectype, int address));
