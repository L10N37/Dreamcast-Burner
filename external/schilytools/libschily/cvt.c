...
/*
 * RB_MINGW_PRIVATE_STRTOD
 * strtod.c is included here for its dtoa implementation when ecvt() is
 * unavailable. Modern MinGW already supplies strtod(), so keep Schily's
 * bundled copy private and avoid colliding with the CRT definition.
 */
#define	strtod	rb_schily_private_strtod
#endif
#include "strtod.c"
#if defined(__MINGW32__)
#undef	strtod
