...
#define	a_to_u_4_byte(a)	((unsigned long) \
 ...
 */
#define	li_to_2_byte(a, i)	(((unsigned char *)(a))[1] = ((i) >> 8) & 0xFF,\
				    ((unsigned char *)(a))[0] = (i) & 0xFF)

#define	li_to_3_byte(a, i)	(((unsigned char *)(a))[2] = ((i) >> 16)& 0xFF,\
				    ((unsigned char *)(a))[1] = ((i) >> 8) & 0xFF,\
				    ((unsigned char *)(a))[0] = (i) & 0xFF)

#define	li_to_4_byte(a, i)	(((unsigned char *)(a))[3] = ((i) >> 24)& 0xFF,\
...
#define	la_to_u_3_byte(a)	((unsigned long) \
				((((unsigned char*)a)[0]		& 0xFF) | \
				    (((unsigned char*)a)[1] << 8	& 0xFF00) | \
...
#define	la_to_u_4_byte(a)	((unsigned long) \
				((((unsigned char*)a)[0]		& 0xFF) | \
				    (((unsigned char*)a)[1] << 8	& 0xFF00) | \
				    (((unsigned char*)a)[2] << 16	& 0xFF0000) | \
				    (((unsigned char*)a)[3] << 24	& __TOP_4BYTE)))
