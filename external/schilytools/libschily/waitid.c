...
/* RB_MINGW_WAITPID_ERRNO_INCLUDE */
...
#if defined(__MINGW32__)
/*
 * RB_MINGW_WAITPID_ENOSYS
 * Native MinGW does not provide POSIX waitpid(). This compatibility function
 * is generic libschily process support and is not used by cdrecord.
 */
LOCAL pid_t
rb_mingw_waitpid(pid, status, opts)
	pid_t	pid;
	int	*status;
	int	opts;
{
...
#define	waitpid	rb_mingw_waitpid
#endif
