...
typedef	struct	{
	...
	unsigned long	f_cmdflags;	/* Command specific flags		  */

	char	*f_name;	/* Zeiger auf den langen Dateinamen	  */
	unsigned long	f_namelen;	/* L�nge des Dateinamens		  */
	char	*f_lname;	/* Zeiger auf den langen Linknamen	  */
	unsigned long	f_lnamelen;	/* L�nge des Linknamens			  */

	char	*f_uname;	/* User name oder NULL Pointer		  */
	unsigned long	f_umaxlen;	/* Maximale L�nge des Usernamens	  */
	char	*f_gname;	/* Group name oder NULL Pointer		  */
	unsigned long	f_gmaxlen;	/* Maximale L�nge des Gruppennamens	  */
	...
	uint64_t	f_llsize;	/* Dateigroesze wenn off_t zu kein	  */
	off_t	f_size;		/* Dateigroesze				  */
	off_t	f_rsize;	/* Dateigroesze auf Band		  */

	unsigned long	f_flags;	/* Bearbeitungshinweise			  */
	unsigned long	f_xflags;	/* Flags f�r x-header			  */
	unsigned long	f_xftype;	/* Header Dateityp (neu generell)	  */
	unsigned long	f_rxftype;	/* Echter Dateityp (neu generell)	  */
...
#else
	unsigned long	f_rdev;		/* Major/Minor bei Geraeten		  */
	unsigned long	f_rdevmaj;	/* Major bei Geraeten			  */
	unsigned long	f_rdevmin;	/* Minor bei Geraeten			  */
#endif
...
#define	XF_LINKPATH	0x0200	/* Langer Link Name			  */
				/* Dateigr��e auf Band (f_rsize)	  */
#define	XF_SIZE		0x0400	/* Dateigr��e wenn > 8 GB		  */
#define	XF_CHARSET	0x0800	/* Zeichensatz f�r Dateiinhalte		  */

#define	XF_DEVMAJOR	0x1000	/* Major bei Ger�ten			  */
#define	XF_DEVMINOR	0x2000	/* Major bei Ger�ten			  */
#define	XF_FSDEVMAJOR	0x4000	/* Major Filesys			  */
#define	XF_FSDEVMINOR	0x8000	/* Major Filesys			  */

#define	XF_FFLAGS	0x10000	/* File flags				  */
				/* Echte Dateigr��e (f_size)		  */
#define	XF_REALSIZE	0x20000	/* Dateigr��e wenn > 8 GB		  */
