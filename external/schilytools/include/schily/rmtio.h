...
struct rmtget	{
	...
	int64_t		mt_dsreg;	/* ``drive status'' register	    */
	int32_t		mt_dsreg1;	/* ``drive status'' register	    */
	int32_t		mt_dsreg2;	/* ``drive status'' register	    */
	int64_t		mt_gstat;	/* ``generic status'' register	    */
	int64_t		mt_erreg;	/* ``error'' register		    */
	/* optional error info.						    */
	int64_t		mt_resid;	/* residual count		    */
	int64_t		mt_fileno;	/* file number of current position  */
	int64_t		mt_blkno;	/* block number of current position */
	int64_t		mt_flags;
	int64_t		mt_gflags;	/* generic flags		    */
