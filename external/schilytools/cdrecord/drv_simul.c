...
LOCAL	int	cdr_write_simul		__PR((SCSI *scgp, char * bp, long sectaddr, long size, int blocks, BOOL islast));
...
LOCAL	unsigned int	sleep_rest;
LOCAL	unsigned int	sleep_max;
LOCAL	unsigned int	sleep_min;
