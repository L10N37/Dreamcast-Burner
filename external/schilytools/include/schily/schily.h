...
extern	int	getllxnum __PR((char *arg, int64_t *lvalp, gnmult_t *mult));

extern	int	getlltnum  __PR((char *arg, int64_t *lvalp));
extern	int	getxtnum  __PR((char *arg, time_t *valp, gnmult_t *mult));
extern	int	getllxtnum __PR((char *arg, int64_t *lvalp, gnmult_t *mult));
#endif
...
#ifdef	_SCHILY_UTYPES_H
extern	int64_t		mklgmtime	__PR((struct tm *));
#endif
...
#ifdef	_SCHILY_UTYPES_H
extern	char	*astoll __PR((const char *, int64_t *));
extern	char	*astollb __PR((const char *, int64_t *, int));
extern	char	*astoull __PR((const char *, uint64_t *));
extern	char	*astoullb __PR((const char *, uint64_t *, int));
#endif
