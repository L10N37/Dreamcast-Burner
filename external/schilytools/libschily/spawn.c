...
#ifndef	__DO__FSPAWNL__
/*
 * RB_MINGW_SPAWN_ENOSYS
 * Native MinGW has no fork()/vfork()/wait() process model. These generic
 * libschily fspawn helpers are not used by cdrecord. Preserve the exported
 * API but report that this optional operation is unsupported on this build.
 */
